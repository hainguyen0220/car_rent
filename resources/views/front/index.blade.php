...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">hapaco<span> Yên Sơn</span></a>
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="#">Thuê xe cưới</a>
          <a class="dropdown-item" href="#">Thuê xe du lịch</a>
          <a class="dropdown-item" href="#">Thuê xe tháng</a>
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-8 ftco-animate">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
	            ...
	            <p style="font-size: 18px;">Đồng hành cùng khách hàng trên mọi nẻo đường với kết nối nhanh chóng, thuê xe - cho thuê xe với vài thao tác đơn giản hoàn toàn bảo mật thông tin khách thuê.</p>
		...
		<section class="ftco-section">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-3">Tại sao nên chọn chúng tôi</h2>
                ...
                <p>Lựa chọn những dòng xe, mức giá, thời gian,... theo lịch trình của mình với thông tin cụ thể của chiếc xe như biển số, hình ảnh, cấu hình đúng 100%</p>
              </div>
            </div>
					</div>
					<div class="col-md-3">
